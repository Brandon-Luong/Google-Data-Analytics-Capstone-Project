...
- Users slept more consistently on the weekdays vs the weekends.
- Users did not have any trouble sleeping.
  - in_bed_hours about the same as sleep_hours.
  
- Walking burns more calories than jogging or sprinting when performed for a longer duration or distance.
</div>
