...
As expected, the average hours of sleep per day is about 7 hours, except for Sunday for which its average is 8 hours (though a 1 hour difference isn't that significant). This can likely correspond to "lazy Sundays" in which people tend to sleep in after a night of drinking or going out on Saturday. Saturday and Sunday also have the largest range of values (ie. largest boxes) which can correspond with people's weekend plans. Contrasting this with Monday to Friday, the "work days," in which the boxes are much smaller meaning they mostly slept on a consistent schedule.
